    ...
    <div className="overview-desktop-container">
      ...
      <div className="about-row">
        ...
        <div className="about-col">
          ...
          <div>
            <h2 className="desktop-heading2 desktop-column-heading">{OverviewText["curious-heading"]}</h2>
            <p className="desktop-body">{OverviewText.curious1}{OverviewText.curious2}</p>
          </div>
          <div>
      ...
      <div className="desktop-columns">
        <div className="desktop-column">
          <h2 className="desktop-heading2 desktop-column-heading">{OverviewText["task-heading1"]}</h2>
          <p className="desktop-body">{OverviewText["task-text1"]}</p>
        </div>
        <div className="desktop-column">
          <h2 className="desktop-heading2 desktop-column-heading">{OverviewText["task-heading2"]}</h2>
      ...
      <div className="desktop-columns">
        ...
        <div className="desktop-column">
          <h2 className="desktop-heading2 desktop-column-heading">{OverviewText["work-with-industry"]}</h2>
