    ...
    return (
        <div className="home-container">
            ...
            <div className="expectation-section">
                ...
                <p className="expectation-text">UP-Grade is a 10-week, mentor-driven summer program where student teams work on real-world product challenges pitched by industry professionals. Over 10 weeks, you’ll develop the skills to thrive in the product design industry.</p>
